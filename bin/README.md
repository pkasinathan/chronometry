...
**Key Features**:
- ✅ **Auto-Setup**: Creates venv and installs dependencies automatically
- ✅ **Template Processing**: Replaces `{{PROJECT_ROOT}}` for portable configs
...
**What happens**:
1. ✅ Auto-creates virtual environment if missing
2. ✅ Installs dependencies from requirements.txt
3. ✅ Processes plist templates (replaces {{PROJECT_ROOT}} with actual path)
...
- Template-based with `{{PROJECT_ROOT}}` placeholder for portability
- Logs to `{{PROJECT_ROOT}}/logs/webserver.log`
...
- Template-based with `{{PROJECT_ROOT}}` placeholder for portability
- Logs to `{{PROJECT_ROOT}}/logs/menubar.log`
